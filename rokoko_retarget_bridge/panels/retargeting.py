...
class RetargetingPanel(ToolPanel, bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Mixamo Checks")
        row = box.row(align=True)
        row.operator(retargeting.CheckMixamoTargetAxis.bl_idname, text="Check Target Axis", icon="VIEW_ORTHO")
        row.operator(retargeting.FixMixamoTargetAxis.bl_idname, text="Fix Target Axis", icon="ORIENTATION_GLOBAL")
        box.operator(retargeting.FixMixamoBoneMap.bl_idname, text="Fix Mixamo Bone Map", icon="BONE_DATA")
